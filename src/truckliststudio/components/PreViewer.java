...
public class PreViewer extends javax.swing.JPanel {
    ...
    private static int audioLeftLive = 0;
    private static int audioRightLive = 0;
    private boolean smallView = false;

    /**
     * Creates new form Viewer
     */
    public PreViewer(boolean small) {
        initComponents();
        smallView = !small;
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (smallView) {
            if (audioLeftLive > 0 || audioRightLive > 0) {
                graph.setColor(Color.green);
                graph.fillRect(0, h - audioLeftLive * h / 128, 15, audioLeftLive * h / 128);
                graph.fillRect(w - 15, h - audioRightLive * h / 128, 15, audioRightLive * h / 128);
            }
        }
    ...
    public static void setLiveAudioLevelFX(int l, int r) {
        audioLeftLive = l;
        audioRightLive = r;
    }
