 ...
 */
package truckliststudio.remote;
...
//                    System.out.println("TrucklistStudio Remote accepting connections on port " + port);
                    ...
                    ResourceMonitorLabel label = new ResourceMonitorLabel(System.currentTimeMillis() + 10000, "TSRemote listening port: " + WebRemote.getPort());
...
//                            System.out.println("Requesting /" + req);
                            ...
                            String path = ""; 
                            path = "/truckliststudio/remote/resources" + req + ".html";
...
//                + ":" + connection.getPort() + "] " + msg);
    ...
    private void errorReport(PrintStream pout, Socket connection,
        ...
        pout.print("HTTP/1.0 " + code + " " + title + "\r\n"
                ...
                + "</HEAD><BODY>\r\n"
                + "<H1>" + title + "</H1>\r\n" + msg + "<P>\r\n"
                + "<HR><ADDRESS>TrucklistStudio 0.2 at "
