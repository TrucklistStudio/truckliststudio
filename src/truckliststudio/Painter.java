...
public final class Painter extends AbstractRegionPainter {
    ...
    private Color color1 = decodeColor("nimbusYellow", 0.032459438f, -0.55535716f, -0.109803945f, 0);
    private Color color2 = decodeColor("nimbusYellow", 0.08801502f, 0.3642857f, -0.4784314f, 0);
//    private Color color3 = decodeColor("nimbusYellow", 0.08801502f, -0.63174605f, 0.43921566f, 0);
//    private Color color4 = decodeColor("nimbusYellow", 0.05468172f, -0.6145278f, 0.37647057f, 0);
//    private Color color5 = decodeColor("nimbusYellow", 0.032459438f, -0.5953556f, 0.32549018f, 0);
//    private Color color6 = decodeColor("nimbusYellow", 0.032459438f, -0.54616207f, -0.02352941f, 0);
    private Color color7 = decodeColor("nimbusYellow", 0.08801502f, -0.6317773f, 0.4470588f, 0);
    private Color color8 = decodeColor("nimbusYellow", 0.021348298f, -0.61547136f, 0.41960782f, 0);
    private Color color9 = decodeColor("nimbusYellow", 0.032459438f, -0.5985242f, 0.39999998f, 0);
    private Color color10 = decodeColor("nimbusYellow", 0.08801502f, 0.3642857f, -0.52156866f, 0);
//    private Color color11 = decodeColor("nimbusYellow", 0.027408898f, -0.5847884f, 0.2980392f, 0);
//    private Color color12 = decodeColor("nimbusYellow", 0.035931647f, -0.5553123f, 0.23137254f, 0);
//    private Color color13 = decodeColor("nimbusYellow", 0.029681683f, -0.5281874f, 0.18039215f, 0);
//    private Color color14 = decodeColor("nimbusYellow", 0.03801495f, -0.5456242f, 0.3215686f, 0);
    private Color color15 = decodeColor("nimbusYellow", 0.032459438f, -0.59181184f, 0.25490195f, 0);
    private Color color16 = decodeColor("nimbusYellow", 0.05468172f, -0.58308274f, 0.19607842f, 0);
//    private Color color17 = decodeColor("nimbusYellow", 0.046348333f, -0.6006266f, 0.34509802f, 0);
//    private Color color18 = decodeColor("nimbusYellow", 0.046348333f, -0.60015875f, 0.3333333f, 0);
//    private Color color19 = decodeColor("nimbusYellow", 0.004681647f, -0.6197143f, 0.43137252f, 0);
//    private Color color20 = decodeColor("nimbusWhite", 7.13408E-4f, -0.543609f, 0.34509802f, 0);
//    private Color color21 = decodeColor("nimbusBlue", -0.0020751357f, -0.45610264f, 0.2588235f, 0);
//    private Color color22 = decodeColor("nimbusBlue", 5.1498413E-4f, -0.43866998f, 0.24705881f, 0);
//    private Color color23 = decodeColor("nimbusBlue", 5.1498413E-4f, -0.44879842f, 0.29019606f, 0);
    private Color color24 = decodeColor("nimbusGreen", 5.1498413E-4f, -0.08776909f, -0.2627451f, 0);
    private Color color25 = decodeColor("nimbusGreen", 5.1498413E-4f, -0.08776909f, -0.2627451f, 0);
//    private Color color26 = decodeColor("nimbusGreen", 5.1498413E-4f, -0.08776909f, -0.2627451f, 0);
...
//    private Color color37 = decodeColor("nimbusAlertYellow", 5.1498413E-4f, -0.08776909f, -0.2627451f, 0);
